        ...
        case PF_Cmd_RENDER:
            ...
            for (A_long y = output->extent_hint.top; y < output->extent_hint.bottom; ++y) {
                ...
                for (A_long x = output->extent_hint.left; x < output->extent_hint.right; ++x) {
                    ...
                    PF_Pixel out_p;
                    out_p.alpha = (A_u_char)(in_p.alpha * amt / 100);
                    out_p.red = (A_u_char)(in_p.red * amt / 100);
                    out_p.green = (A_u_char)(in_p.green * amt / 100);
                    out_p.blue = (A_u_char)(in_p.blue * amt / 100);
                    out_row[x] = out_p;
                }
            }
            break;
