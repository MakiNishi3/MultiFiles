        ...
        case PF_Cmd_RENDER:
            ...
            for (A_long y = output->extent_hint.top; y < output->extent_hint.bottom; ++y) {
                ...
                for (A_long x = output->extent_hint.left; x < output->extent_hint.right; ++x) {
                    ...
                    PF_Pixel out_p;
                    out_p.red = (A_u_char)(in_p.red + ((255 - in_p.red) - in_p.red) * amt / 100);
                    out_p.green = (A_u_char)(in_p.green + ((255 - in_p.green) - in_p.green) * amt / 100);
                    out_p.blue = (A_u_char)(in_p.blue + ((255 - in_p.blue) - in_p.blue) * amt / 100);
